...
<body>
 <div class="wrapper">
  <table width="100%" align="center">
   ...
   <tr><td width="100%" valign="top" align="center">
    <label class='heading1'><b>Vendor Report</b></label>
   </td></tr>
   <tr><td width="100%" valign="top" align="center">
    ...
    <td width="100%" valign="top" align="center">
     <table width="95%" align="center">
      <tr>
       ...
       <th width='20%' align='left'><label class='heading8'>Report Name</label></th>
       <th width='35%' align='left'><label class='heading8'>Address</label></th>
       <th width='15%' align='left'><label class='heading8'>Country</label></th>
