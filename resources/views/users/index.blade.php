      ...
      <div class="aside">
         ...
         <nav class="aside-body">
            ...
            <ul class="nav flex-column">
               <li><a class="active" data-toggle="tab" href="#general">Users</a></li>
               <li><a data-toggle="tab" href="#c_pass">Users Rights</a></li>
               <li><a data-toggle="tab" href="#info">Page Rights</a></li>
