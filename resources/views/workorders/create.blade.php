    ...
    <div class="tab-content">
     ...
     <div id="step-workorder" class="tab-pane " role="tabpanel">
      ...
      <div class="card-body">
       ...
       <form action="{{ url('/workorders/workorder/') }}" method="post">
        @csrf
        @method('PUT')
        <div class="row">
         <div class="col-lg-6 border-right">
          ...
          <div class="form-row mb-2">
           ...
           <div class="col-sm-9">
            ...
            <div class="dashboard-date style--four">
             ...
             <input type="text" class="simple-date-picker" placeholder="Select Date" name="date_received"/>
            </div>
            <!-- End Date Picker -->
           </div>
          </div>
          ...
          <div class="form-row mb-2"> 
           ...
           <div class="col-sm-9">
            ...
            <div class="dashboard-date style--four">
             ...
             <input type="text" class="simple-date-picker" placeholder="Select Date" name="date_delivered"/>
            </div>
            <!-- End Date Picker -->
           </div>
          </div>
          ...
          <div class="form-row mb-2">
           ...
           <div class="col-sm-9">
            <input type="text" class="theme-input-style" name="amount_due" readonly>
           </div>
          </div>
         ...
         <div class="col-lg-6">
          ...
          <div class="form-row mb-2">
           <div class="col-sm-9 offset-sm-3">
            <div class="d-flex align-items-center">
             <label class="custom-checkbox position-relative mr-2">
              <input type="checkbox" id="taxable_invoice">
              <span class="checkmark"></span>
             </label>
          ...
          <div class="form-row mb-2">
           ...
           <div class="col-sm-9">
            <input type="text" class="theme-input-style" name="" readonly>
           </div>
          </div>
