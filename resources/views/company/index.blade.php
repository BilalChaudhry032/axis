      ...
      <div class="card mb-30">
         <div class="card-body">
            <div class="d-flex justify-content-between">
               <form action="{{ url('/company') }}" class="search-form flex-grow">
         ...
         <div class="table-responsive">
            <table class="text-nowrap invoice-list">
                  ...
                  <tbody>
                        ...
                        <td>
                              ...
                              <div class="dropdown-button">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right">
                                    <a href="" data-toggle="modal" data-target="#company_edit_modal_{{ $company->company_id }}">Edit</a>
                                    
                                    <a href="" data-toggle="modal" data-target="#company_delete_modal_{{ $company->company_id }}">Delete</a>
                                 </div>
                              </div>
                              <!-- End Dropdown Button -->
                        </td>
                     ...
                     <!-- Modal Edit -->
                     <div class="modal fade" id="company_edit_modal_{{ $company->company_id }}" tabindex="-1" role="dialog" aria-labelledby="company_edit_label" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <form action="{{ url('/company/'.$company->company_id) }}" method="POST">
                                 @csrf
                                 @method('PUT')
                                 <div class="modal-body">
                                    <div class="form-group">
                                       <label for="message-text" class="col-form-label">Company Name</label>
                                       <input class="form-control" required name="name" value="{{ $company->name }}">
                                    </div>
                                 </div>
                                 <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary bg-secondary" data-dismiss="modal">Close</button>
                     ...
                     <!-- Modal Delete -->
                     <div class="modal fade" id="company_delete_modal_{{ $company->company_id }}" tabindex="-1" role="dialog" aria-labelledby="company_delete_label" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <form action="{{ url('/company/'.$company->company_id) }}" method="POST">
                                 @csrf
